...
public class RobotContainer {
  ...
  private final CommandJoystick driverThrustController = new CommandJoystick (Constants.OperatorConstants.THRUST_JOYSTICK_PORT);
  ...
  public RobotContainer() {
    ...
    autoChooser.setDefaultOption("Autonomous", Autos.circleAuto(driveSubsystem));
  }
  ...
  private void configureBindings() {
    ...
    driveSubsystem.setDefaultCommand(
        driveSubsystem.driveArcade(
            driveSubsystem, () -> -driverThrustController.getY() * (driverThrustController.getThrottle()+1)/2, () -> -driverThrustController.getTwist() * (driverThrustController.getThrottle()+1)/2));
